...
struct ImVec2
{
    ...
    float  operator[] (size_t idx) const    { (void)( (!!(idx <= 1)) || (_wassert(L"idx <= 1", L"D:\\Open Source\\cimgui\\cimgui\\generator\\../imgui/imgui.h", (unsigned)(259)), 0) ); return (&x)[idx]; }    
    float& operator[] (size_t idx)          { (void)( (!!(idx <= 1)) || (_wassert(L"idx <= 1", L"D:\\Open Source\\cimgui\\cimgui\\generator\\../imgui/imgui.h", (unsigned)(260)), 0) ); return (&x)[idx]; }    
};
struct ImVec4
{
    float                                                     x, y, z, w;
...
struct ImVector
{
    ...
    inline T&           operator[](int i)                   { (void)( (!!(i >= 0 && i < Size)) || (_wassert(L"i >= 0 && i < Size", L"D:\\Open Source\\cimgui\\cimgui\\generator\\../imgui/imgui.h", (unsigned)(1856)), 0) ); return Data[i]; }
    inline const T&     operator[](int i) const             { (void)( (!!(i >= 0 && i < Size)) || (_wassert(L"i >= 0 && i < Size", L"D:\\Open Source\\cimgui\\cimgui\\generator\\../imgui/imgui.h", (unsigned)(1857)), 0) ); return Data[i]; }
    inline T*           begin()                             { return Data; }
    inline const T*     begin() const                       { return Data; }
    inline T*           end()                               { return Data + Size; }
    inline const T*     end() const                         { return Data + Size; }
    inline T&           front()                             { (void)( (!!(Size > 0)) || (_wassert(L"Size > 0", L"D:\\Open Source\\cimgui\\cimgui\\generator\\../imgui/imgui.h", (unsigned)(1863)), 0) ); return Data[0]; }
    inline const T&     front() const                       { (void)( (!!(Size > 0)) || (_wassert(L"Size > 0", L"D:\\Open Source\\cimgui\\cimgui\\generator\\../imgui/imgui.h", (unsigned)(1864)), 0) ); return Data[0]; }
    inline T&           back()                              { (void)( (!!(Size > 0)) || (_wassert(L"Size > 0", L"D:\\Open Source\\cimgui\\cimgui\\generator\\../imgui/imgui.h", (unsigned)(1865)), 0) ); return Data[Size - 1]; }
    inline const T&     back() const                        { (void)( (!!(Size > 0)) || (_wassert(L"Size > 0", L"D:\\Open Source\\cimgui\\cimgui\\generator\\../imgui/imgui.h", (unsigned)(1866)), 0) ); return Data[Size - 1]; }
    inline void         swap(ImVector<T>& rhs)              { int rhs_size = rhs.Size; rhs.Size = Size; Size = rhs_size; int rhs_cap = rhs.Capacity; rhs.Capacity = Capacity; Capacity = rhs_cap; T* rhs_data = rhs.Data; rhs.Data = Data; Data = rhs_data; }
    inline int          _grow_capacity(int sz) const        { int new_capacity = Capacity ? (Capacity + Capacity / 2) : 8; return new_capacity > sz ? new_capacity : sz; }
    inline void         resize(int new_size)                { if (new_size > Capacity) reserve(_grow_capacity(new_size)); Size = new_size; }
    inline void         resize(int new_size, const T& v)    { if (new_size > Capacity) reserve(_grow_capacity(new_size)); if (new_size > Size) for (int n = Size; n < new_size; n++) memcpy(&Data[n], &v, sizeof(v)); Size = new_size; }
    inline void         shrink(int new_size)                { (void)( (!!(new_size <= Size)) || (_wassert(L"new_size <= Size", L"D:\\Open Source\\cimgui\\cimgui\\generator\\../imgui/imgui.h", (unsigned)(1872)), 0) ); Size = new_size; } 
    ...
    inline void         pop_back()                          { (void)( (!!(Size > 0)) || (_wassert(L"Size > 0", L"D:\\Open Source\\cimgui\\cimgui\\generator\\../imgui/imgui.h", (unsigned)(1878)), 0) ); Size--; }
    inline void         push_front(const T& v)              { if (Size == 0) push_back(v); else insert(Data, v); }
    inline T*           erase(const T* it)                  { (void)( (!!(it >= Data && it < Data + Size)) || (_wassert(L"it >= Data && it < Data + Size", L"D:\\Open Source\\cimgui\\cimgui\\generator\\../imgui/imgui.h", (unsigned)(1880)), 0) ); const ptrdiff_t off = it - Data; memmove(Data + off, Data + off + 1, ((size_t)Size - (size_t)off - 1) * sizeof(T)); Size--; return Data + off; }
    inline T*           erase(const T* it, const T* it_last){ (void)( (!!(it >= Data && it < Data + Size && it_last >= it && it_last <= Data + Size)) || (_wassert(L"it >= Data && it < Data + Size && it_last >= it && it_last <= Data + Size", L"D:\\Open Source\\cimgui\\cimgui\\generator\\../imgui/imgui.h", (unsigned)(1881)), 0) ); const ptrdiff_t count = it_last - it; const ptrdiff_t off = it - Data; memmove(Data + off, Data + off + count, ((size_t)Size - (size_t)off - (size_t)count) * sizeof(T)); Size -= (int)count; return Data + off; }
    inline T*           erase_unsorted(const T* it)         { (void)( (!!(it >= Data && it < Data + Size)) || (_wassert(L"it >= Data && it < Data + Size", L"D:\\Open Source\\cimgui\\cimgui\\generator\\../imgui/imgui.h", (unsigned)(1882)), 0) );  const ptrdiff_t off = it - Data; if (it < Data + Size - 1) memcpy(Data + off, Data + Size - 1, sizeof(T)); Size--; return Data + off; }
    inline T*           insert(const T* it, const T& v)     { (void)( (!!(it >= Data && it <= Data + Size)) || (_wassert(L"it >= Data && it <= Data + Size", L"D:\\Open Source\\cimgui\\cimgui\\generator\\../imgui/imgui.h", (unsigned)(1883)), 0) ); const ptrdiff_t off = it - Data; if (Size == Capacity) reserve(_grow_capacity(Size + 1)); if (off < (int)Size) memmove(Data + off + 1, Data + off, ((size_t)Size - (size_t)off) * sizeof(T)); memcpy(&Data[off], &v, sizeof(v)); Size++; return Data + off; }
    ...
    inline int          index_from_ptr(const T* it) const   { (void)( (!!(it >= Data && it < Data + Size)) || (_wassert(L"it >= Data && it < Data + Size", L"D:\\Open Source\\cimgui\\cimgui\\generator\\../imgui/imgui.h", (unsigned)(1889)), 0) ); const ptrdiff_t off = it - Data; return (int)off; }
};
struct ImGuiStyle
{
    float       Alpha;                      
...
struct ImGuiTextBuffer
{
    ...
    ImGuiTextBuffer()   { }
    inline char         operator[](int i) const { (void)( (!!(Buf.Data != ((void *)0))) || (_wassert(L"Buf.Data != ((void *)0)", L"D:\\Open Source\\cimgui\\cimgui\\generator\\../imgui/imgui.h", (unsigned)(2312)), 0) ); return Buf.Data[i]; }
...
struct ImFontAtlas
{
    ...
    ImFontAtlasCustomRect*      GetCustomRectByIndex(int index) { (void)( (!!(index >= 0)) || (_wassert(L"index >= 0", L"D:\\Open Source\\cimgui\\cimgui\\generator\\../imgui/imgui.h", (unsigned)(2901)), 0) ); return &CustomRects[index]; }
...
struct ImGuiViewport
{
    ...
    ~ImGuiViewport()    { (void)( (!!(PlatformUserData == ((void *)0) && RendererUserData == ((void *)0))) || (_wassert(L"PlatformUserData == ((void *)0) && RendererUserData == ((void *)0)", L"D:\\Open Source\\cimgui\\cimgui\\generator\\../imgui/imgui.h", (unsigned)(3054)), 0) ); }
...
struct ImBitArray
{
    ...
    bool            TestBit(int n) const        { n += OFFSET; (void)( (!!(n >= 0 && n < BITCOUNT)) || (_wassert(L"n >= 0 && n < BITCOUNT", L"D:\\Open Source\\cimgui\\cimgui\\generator\\../imgui/imgui_internal.h", (unsigned)(571)), 0) ); return ImBitArrayTestBit(Storage, n); }
    void            SetBit(int n)               { n += OFFSET; (void)( (!!(n >= 0 && n < BITCOUNT)) || (_wassert(L"n >= 0 && n < BITCOUNT", L"D:\\Open Source\\cimgui\\cimgui\\generator\\../imgui/imgui_internal.h", (unsigned)(572)), 0) ); ImBitArraySetBit(Storage, n); }
    void            ClearBit(int n)             { n += OFFSET; (void)( (!!(n >= 0 && n < BITCOUNT)) || (_wassert(L"n >= 0 && n < BITCOUNT", L"D:\\Open Source\\cimgui\\cimgui\\generator\\../imgui/imgui_internal.h", (unsigned)(573)), 0) ); ImBitArrayClearBit(Storage, n); }
    void            SetBitRange(int n, int n2)  { n += OFFSET; n2 += OFFSET; (void)( (!!(n >= 0 && n < BITCOUNT && n2 > n && n2 <= BITCOUNT)) || (_wassert(L"n >= 0 && n < BITCOUNT && n2 > n && n2 <= BITCOUNT", L"D:\\Open Source\\cimgui\\cimgui\\generator\\../imgui/imgui_internal.h", (unsigned)(574)), 0) ); ImBitArraySetBitRange(Storage, n, n2); } 
    bool            operator[](int n) const     { n += OFFSET; (void)( (!!(n >= 0 && n < BITCOUNT)) || (_wassert(L"n >= 0 && n < BITCOUNT", L"D:\\Open Source\\cimgui\\cimgui\\generator\\../imgui/imgui_internal.h", (unsigned)(575)), 0) ); return ImBitArrayTestBit(Storage, n); }
};
struct  ImBitVector
{
    ...
    bool            TestBit(int n) const        { (void)( (!!(n < (Storage.Size << 5))) || (_wassert(L"n < (Storage.Size << 5)", L"D:\\Open Source\\cimgui\\cimgui\\generator\\../imgui/imgui_internal.h", (unsigned)(585)), 0) ); return ImBitArrayTestBit(Storage.Data, n); }
    void            SetBit(int n)               { (void)( (!!(n < (Storage.Size << 5))) || (_wassert(L"n < (Storage.Size << 5)", L"D:\\Open Source\\cimgui\\cimgui\\generator\\../imgui/imgui_internal.h", (unsigned)(586)), 0) ); ImBitArraySetBit(Storage.Data, n); }
    void            ClearBit(int n)             { (void)( (!!(n < (Storage.Size << 5))) || (_wassert(L"n < (Storage.Size << 5)", L"D:\\Open Source\\cimgui\\cimgui\\generator\\../imgui/imgui_internal.h", (unsigned)(587)), 0) ); ImBitArrayClearBit(Storage.Data, n); }
};
template<typename T>
struct ImSpan
{
    ...
    inline T&           operator[](int i)           { T* p = Data + i; (void)( (!!(p >= Data && p < DataEnd)) || (_wassert(L"p >= Data && p < DataEnd", L"D:\\Open Source\\cimgui\\cimgui\\generator\\../imgui/imgui_internal.h", (unsigned)(607)), 0) ); return *p; }
    inline const T&     operator[](int i) const     { const T* p = Data + i; (void)( (!!(p >= Data && p < DataEnd)) || (_wassert(L"p >= Data && p < DataEnd", L"D:\\Open Source\\cimgui\\cimgui\\generator\\../imgui/imgui_internal.h", (unsigned)(608)), 0) ); return *p; }
    inline T*           begin()                     { return Data; }
    inline const T*     begin() const               { return Data; }
    inline T*           end()                       { return DataEnd; }
    inline const T*     end() const                 { return DataEnd; }
    inline int  index_from_ptr(const T* it) const   { (void)( (!!(it >= Data && it < DataEnd)) || (_wassert(L"it >= Data && it < DataEnd", L"D:\\Open Source\\cimgui\\cimgui\\generator\\../imgui/imgui_internal.h", (unsigned)(616)), 0) ); const ptrdiff_t off = it - Data; return (int)off; }
};
template<int CHUNKS>
struct ImSpanAllocator
{
    ...
    inline void  Reserve(int n, size_t sz, int a=4) { (void)( (!!(n == CurrIdx && n < CHUNKS)) || (_wassert(L"n == CurrIdx && n < CHUNKS", L"D:\\Open Source\\cimgui\\cimgui\\generator\\../imgui/imgui_internal.h", (unsigned)(632)), 0) ); CurrOff = (((CurrOff) + ((a) - 1)) & ~((a) - 1)); Offsets[n] = CurrOff; Sizes[n] = (int)sz; CurrIdx++; CurrOff += (int)sz; }
    inline int   GetArenaSizeInBytes()              { return CurrOff; }
    inline void  SetArenaBasePtr(void* base_ptr)    { BasePtr = (char*)base_ptr; }
    inline void* GetSpanPtrBegin(int n)             { (void)( (!!(n >= 0 && n < CHUNKS && CurrIdx == CHUNKS)) || (_wassert(L"n >= 0 && n < CHUNKS && CurrIdx == CHUNKS", L"D:\\Open Source\\cimgui\\cimgui\\generator\\../imgui/imgui_internal.h", (unsigned)(635)), 0) ); return (void*)(BasePtr + Offsets[n]); }
    inline void* GetSpanPtrEnd(int n)               { (void)( (!!(n >= 0 && n < CHUNKS && CurrIdx == CHUNKS)) || (_wassert(L"n >= 0 && n < CHUNKS && CurrIdx == CHUNKS", L"D:\\Open Source\\cimgui\\cimgui\\generator\\../imgui/imgui_internal.h", (unsigned)(636)), 0) ); return (void*)(BasePtr + Offsets[n] + Sizes[n]); }
    template<typename T>
...
struct ImPool
{
    ...
    ImPoolIdx   GetIndex(const T* p) const          { (void)( (!!(p >= Buf.Data && p < Buf.Data + Buf.Size)) || (_wassert(L"p >= Buf.Data && p < Buf.Data + Buf.Size", L"D:\\Open Source\\cimgui\\cimgui\\generator\\../imgui/imgui_internal.h", (unsigned)(657)), 0) ); return (ImPoolIdx)(p - Buf.Data); }
...
struct ImChunkStream
{
    ...
    T*      next_chunk(T* p)            { size_t HDR_SZ = 4; (void)( (!!(p >= begin() && p < end())) || (_wassert(L"p >= begin() && p < end()", L"D:\\Open Source\\cimgui\\cimgui\\generator\\../imgui/imgui_internal.h", (unsigned)(692)), 0) ); p = (T*)(void*)((char*)(void*)p + chunk_size(p)); if (p == (T*)(void*)((char*)end() + HDR_SZ)) return (T*)0; (void)( (!!(p < end())) || (_wassert(L"p < end()", L"D:\\Open Source\\cimgui\\cimgui\\generator\\../imgui/imgui_internal.h", (unsigned)(692)), 0) ); return p; }
    int     chunk_size(const T* p)      { return ((const int*)p)[-1]; }
    T*      end()                       { return (T*)(void*)(Buf.Data + Buf.Size); }
    int     offset_from_ptr(const T* p) { (void)( (!!(p >= begin() && p < end())) || (_wassert(L"p >= begin() && p < end()", L"D:\\Open Source\\cimgui\\cimgui\\generator\\../imgui/imgui_internal.h", (unsigned)(695)), 0) ); const ptrdiff_t off = (const char*)p - Buf.Data; return (int)off; }
    T*      ptr_from_offset(int off)    { (void)( (!!(off >= 4 && off < Buf.Size)) || (_wassert(L"off >= 4 && off < Buf.Size", L"D:\\Open Source\\cimgui\\cimgui\\generator\\../imgui/imgui_internal.h", (unsigned)(696)), 0) ); return (T*)(void*)(Buf.Data + off); }
...
struct ImGuiNavItemData
{
    ...
    void Clear()        { Window = ((void *)0); ID = FocusScopeId = 0; InFlags = 0; DistBox = DistCenter = DistAxial = 3.402823466e+38F; }
};
...
struct ImGuiViewportP : public ImGuiViewport
{
    ...
    ImGuiViewportP()                    { Idx = -1; LastFrameActive = DrawListsLastFrame[0] = DrawListsLastFrame[1] = LastFrontMostStampCount = -1; LastNameHash = 0; Alpha = LastAlpha = 1.0f; PlatformMonitor = -1; PlatformWindowCreated = false; Window = ((void *)0); DrawLists[0] = DrawLists[1] = ((void *)0); LastPlatformPos = LastPlatformSize = LastRendererSize = ImVec2(3.402823466e+38F, 3.402823466e+38F); }
...
struct ImGuiStackTool
{
    ...
    ImGuiStackTool()        { memset(this, 0, sizeof(*this)); CopyToClipboardLastTime = -3.402823466e+38F; }
};
...
struct  ImGuiTabBar
{
    ...
    const char*         GetTabName(const ImGuiTabItem* tab) const
    {
        ...
        (void)( (!!(tab->NameOffset != -1 && tab->NameOffset < TabsNames.Buf.Size)) || (_wassert(L"tab->NameOffset != -1 && tab->NameOffset < TabsNames.Buf.Size", L"D:\\Open Source\\cimgui\\cimgui\\generator\\../imgui/imgui_internal.h", (unsigned)(2485)), 0) );
...
namespace ImGui
{
    ...
    inline ImGuiKey         MouseButtonToKey(ImGuiMouseButton button)                   { (void)( (!!(button >= 0 && button < ImGuiMouseButton_COUNT)) || (_wassert(L"button >= 0 && button < ImGuiMouseButton_COUNT", L"D:\\Open Source\\cimgui\\cimgui\\generator\\../imgui/imgui_internal.h", (unsigned)(2949)), 0) ); return ImGuiKey_MouseLeft + button; }
    ...
    inline bool             IsKeyPressedMap(ImGuiKey key, bool repeat = true)           { (void)( (!!(IsNamedKey(key))) || (_wassert(L"IsNamedKey(key)", L"D:\\Open Source\\cimgui\\cimgui\\generator\\../imgui/imgui_internal.h", (unsigned)(2958)), 0) ); return IsKeyPressed(key, repeat); } 
